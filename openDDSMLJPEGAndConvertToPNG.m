...
%                        ----(MAIN FILE)----
% ==================================================================%
%           Author - Anmol Sharma (modified by Se-In JANG in 06Dec 2018)
...
for t = 1:numOfFolders1
    ...
    if(~strcmp(AllCollectionsOfDDSM{1,t}, '.') && ...
            ...
            AllCollectionsOfDDSM{5,t} == 1)         % for MATLAB 2018
%             AllCollectionsOfDDSM{4,t} == 1)         % for MATLAB 2015
        ...
        for i = 1:numOfFolders
            % DIR command also outputs "." and "..", so we need to skip those
            if(~strcmp(a{1,i}, '.') && ~strcmp(a{1,i}, '..') && a{5,i} == 1) % for MATLAB 2018
%             if(~strcmp(a{1,i}, '.') && ~strcmp(a{1,i}, '..') && a{4,i} ==
%             1) % for MATLAB 2015
